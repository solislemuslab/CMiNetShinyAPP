...
## Source Code
The CMiNetShinyApp is an [open-source project](https://cminet.wid.wisc.edu), and its source code is available in this repository. The main web app code is located in app.R.

...
server <- function(input, output, session) {
  ...
  algorithm_links <- list(
    ...
    c_MI = "https://github.com/solislemuslab/CMIMN",
    ...
    tagList(
      ...
      if (edge_list_exists) {
        tags$div(
          ...
          tags$p("This CSV file contains the resulting edge list. It has four columns: the first and second columns represent the names of the connected nodes, the third column indicates the weight of the edge between them, and the fourth column specifies the methods that confirmed the edge.")
        )
      },
      tags$div(
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        tags$i(
          ...
          title = "Download Sample Gut Microbiome Data from the American Gut Project."
        ),
        ...
        numericInputIcon(
          ...
          label = tags$span(
            ...
            tags$i(
              class = "fa fa-question-circle",
              style = "color: blue; margin-left: 5px; cursor: pointer;",
              title = "The threshold value used for threshold-dependent algorithms (Pearson, Spearman, Bicor, SparCC, and CCLasso). Set to the 0.95 quantile by default to promote sparsity in the consensus network."
            )
          ),
          value = 0.95,
          min = 0,
        ...
        bsTooltip("selectedAlgorithms", "Select the algorithms you want to include in the consensus network construction.", 
                  placement = "right", trigger = "hover"),
        ...
        bsTooltip("run", "Click to run the selected algorithms and generate the consensus network.", 
                  placement = "right", trigger = "hover")
      ),
      mainPanel(
        tabsetPanel(
      ...
      sidebarPanel(
        ...
        conditionalPanel(
          ...
          tags$div(
            ...
            tags$b("The CMiNet result (weighted_network.csv) will be loaded automatically.")
          )
        ),
        
        downloadButton("downloadSampleNet", "Sample WeightedNetwork"),
        tags$i(
          class = "fa fa-question-circle",
          style = "color: blue; margin-left: 5px; cursor: pointer;",
          title = "Download the Gut Microbiome Network Generated by CMiNet from Sample American Gut Data."
        ),
